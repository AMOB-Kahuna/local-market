  ...
  return (
    <>
      <header className='px-3 py-4 border-b border-b-[#F0A500] flex justify-between items-center lg:px-10'>
        ...
        <nav
          className={`
            absolute top-16 right-3 z-40 w-50 flex-col gap-4 rounded-xl bg-[#FFFDF5] p-5 shadow-md
            ${showNav ? 'flex' : 'hidden'}
            sm:static sm:flex sm:flex-row sm:gap-5 sm-p-0 sm:shadow-none text-xl sm-text-nowrap
          `}
        >
